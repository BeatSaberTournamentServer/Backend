...
Gamemode: VERSUS / BR / PokéSaber
    ...
    - PokéSaber is the Pokémon style tournament. Nothing on the frontend is controlled by the relay-server, only sending scores to the frontend.
*/
export default {
    Server: {
        ip: 'wss://domain.com',
